...
const TableNameMemberInfoUTF8 = "member_info_utf8"

// MemberInfoUTF8 mapped from table <member_info_utf8>
...
// TableName MemberInfoUTF8's table name
func (*MemberInfoUTF8) TableName() string {
	return TableNameMemberInfoUTF8
}
