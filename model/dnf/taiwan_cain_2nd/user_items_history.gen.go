...
const TableNameUserItemsHistory = "user_items_history"

// UserItemsHistory mapped from table <user_items_history>
type UserItemsHistory struct {
...
// TableName UserItemsHistory's table name
func (*UserItemsHistory) TableName() string {
	return TableNameUserItemsHistory
}
