...
const TableNameUserItemsDel = "user_items_del"

// UserItemsDel mapped from table <user_items_del>
type UserItemsDel struct {
	...
	Color1          int32     `gorm:"column:color1;not null" json:"color1"`
	Color2          int32     `gorm:"column:color2;not null" json:"color2"`
	TradeRestrict   int32     `gorm:"column:trade_restrict;not null" json:"trade_restrict"`
}

// TableName UserItemsDel's table name
func (*UserItemsDel) TableName() string {
	return TableNameUserItemsDel
}
