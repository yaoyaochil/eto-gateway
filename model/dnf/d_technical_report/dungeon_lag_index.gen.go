...
const TableNameDungeonLagIndex = "dungeon_lag_index"

// DungeonLagIndex mapped from table <dungeon_lag_index>
type DungeonLagIndex struct {
...
// TableName DungeonLagIndex's table name
func (*DungeonLagIndex) TableName() string {
	return TableNameDungeonLagIndex
}
