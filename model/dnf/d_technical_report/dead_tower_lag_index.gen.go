...
const TableNameDeadTowerLagIndex = "dead_tower_lag_index"

// DeadTowerLagIndex mapped from table <dead_tower_lag_index>
type DeadTowerLagIndex struct {
...
// TableName DeadTowerLagIndex's table name
func (*DeadTowerLagIndex) TableName() string {
	return TableNameDeadTowerLagIndex
}
