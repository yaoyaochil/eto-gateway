...
const TableNameFightVillageLagIndex = "fight_village_lag_index"

// FightVillageLagIndex mapped from table <fight_village_lag_index>
type FightVillageLagIndex struct {
...
// TableName FightVillageLagIndex's table name
func (*FightVillageLagIndex) TableName() string {
	return TableNameFightVillageLagIndex
}
