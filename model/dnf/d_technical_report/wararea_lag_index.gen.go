...
const TableNameWarareaLagIndex = "wararea_lag_index"

// WarareaLagIndex mapped from table <wararea_lag_index>
type WarareaLagIndex struct {
...
// TableName WarareaLagIndex's table name
func (*WarareaLagIndex) TableName() string {
	return TableNameWarareaLagIndex
}
